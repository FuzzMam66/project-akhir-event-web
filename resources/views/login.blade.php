    ...
    <div class="hero-bg text-white px-12 py-6 h-max min-h-screen">
        ...
        <div class=" flex items-center justify-center gap-25 max-w-7xl mx-auto py-16 relative z-10">
            <div class="text-center mb-8 font-poppins leading-tight reveal active bg-white p-10 rounded-lg glass-effect">
                <span class=" font-bold text-3xl"> <span class="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Login</span> to Your Account</span>
                <form action="" method="POST" class="space-y-6 text-left mt-7 reveal active">
                    <div>
            ...
            <div class="text-right mb-8 font-poppins leading-tight reveal active ">
                <span class="text-8xl font-bold text-white">New </span> <span class=" text-8xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> Here? </span> <br>
                <div class="text-white my-10">
                    <span class="text-2xl">Join us and explore the world of possibilities.</span>
                </div>
                <a href="#" class="px-8 py-4 bg-gradient-to-r from-blue-400 to-purple-400  text-gray-800 font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    Register Now
                </a>
            </div>
        </div>   
