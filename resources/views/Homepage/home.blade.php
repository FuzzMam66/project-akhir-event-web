    ...
    <header id="home" class="hero-bg text-white px-8 py-4 text-center h-200 relative z-50">
        ...
        <div class="hero max-w-6xl mx-auto py-32 relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center reveal">
                <a href="#" class="btn-glow px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-400 text-gray-900 font-semibold rounded-full shadow-[0_0_30px_rgba(34,197,94,0.4)] hover:shadow-[0_0_50px_rgba(34,197,94,0.6)] transition-all duration-300 transform hover:scale-105 glow-effect">
                    View Created Events
                </a>
        ...
        <div class="max-w-4xl mx-auto relative z-10">
            ...
            <form method="POST" class="glass-effect rounded-3xl p-8 shadow-2xl reveal">
                ...
                <div class="mt-8 text-center">
                    <button type="submit" class="px-12 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg rounded-full hover:shadow-2xl transition-all duration-300 transform hover:scale-105 btn-glow">
                        🚀 Create Event
                    </button>
                </div>
            </form>
